...
+(void)showIntroductoryPageView:(NSArray *)imageArray
{
    if (![introductoryPagesHelper shareInstance].curIntroductoryPagesView) {
        [introductoryPagesHelper shareInstance].curIntroductoryPagesView=[[introductoryPagesView alloc]initPagesViewWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight) Images:imageArray];
    }
